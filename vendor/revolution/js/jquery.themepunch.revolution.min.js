...
!(function (jQuery, undefined) {
  ...
  var _ISM = _R.is_mobile(),
      ...
      e.parent().css({ overflow: "visible" }),
        ...
        u.scrolleffect.on &&
          ...
          u.allli.find(".slotholder").each(function () {
            jQuery(this).wrap(
              '<img style="display:block;position:absolute;top:0px;left:0px;width:100%;height:100%" class="slotholder_fadeoutwrap"></div>'
            );
          }),
    ...
    if($(".rev_slider").children().children().attr('id') == 'kurwa'){
        $('.rev_slider').css('height','200px !important');
    }
})(jQuery);
